...
echo "export WANDB_DATA_DIR=/PATH/TO/CACHE" >> ~/.bashrc
echo "export WANDB_DIR=/PATH/TO/CACHE" >> ~/.bashrc
...
echo "export CONDA_ENVS_PATH=/PATH/TO" >> ~/.bashrc
echo "export MS_ASSET_DIR=/PATH/TO" >> ~/.bashrc # maniskill sim assets
